...
- ♨️ Uses **quiescence search** to avoid horizon effects and evaluate only "quiet" positions.
- ⚙️ Written entirely in idiomatic **Rust**, with a focus on performance and correctness.
